...
hoistedDependencies:
  ...
  '@vitejs/plugin-react@4.7.0(vite@6.3.5(@types/node@24.0.13)(jiti@1.21.7)(yaml@2.8.0))':
    '@vitejs/plugin-react': private
  '@vitest/expect@3.2.4':
    '@vitest/expect': private
  '@vitest/mocker@3.2.4(vite@7.0.4(@types/node@24.0.13)(jiti@1.21.7)(yaml@2.8.0))':
  ...
  eslint-compat-utils@0.6.5(eslint@9.30.1(jiti@1.21.7)):
  ...
  vfile@6.0.3:
    vfile: private
  vite-node@3.2.4(@types/node@24.0.13)(jiti@1.21.7)(yaml@2.8.0):
    vite-node: private
  vite-node@3.2.4(@types/node@24.0.13)(yaml@2.8.0):
    vite-node: private
  vite@6.3.5(@types/node@24.0.13)(jiti@1.21.7)(yaml@2.8.0):
    vite: private
  vite@6.3.5(@types/node@24.0.13)(yaml@2.8.0):
    vite: private
  vitefu@1.1.1(vite@6.3.5(@types/node@24.0.13)(jiti@1.21.7)(yaml@2.8.0)):
    vitefu: private
  vitefu@1.1.1(vite@6.3.5(@types/node@24.0.13)(yaml@2.8.0)):
    vitefu: private
  volar-service-css@0.0.62(@volar/language-service@2.4.18):
    volar-service-css: private
  volar-service-emmet@0.0.62(@volar/language-service@2.4.18):
    volar-service-emmet: private
  volar-service-html@0.0.62(@volar/language-service@2.4.18):
    volar-service-html: private
  volar-service-prettier@0.0.62(@volar/language-service@2.4.18)(prettier@3.6.2):
    volar-service-prettier: private
  volar-service-typescript-twoslash-queries@0.0.62(@volar/language-service@2.4.18):
    volar-service-typescript-twoslash-queries: private
  volar-service-typescript@0.0.62(@volar/language-service@2.4.18):
    volar-service-typescript: private
  volar-service-yaml@0.0.62(@volar/language-service@2.4.18):
...
pendingBuilds: []
prunedAt: Tue, 22 Jul 2025 02:45:35 GMT
publicHoistPattern: []
registries:
...
storeDir: /Users/kharipowell/Library/pnpm/store/v10
